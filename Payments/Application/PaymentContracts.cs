...
public sealed class TelrCheckOrderResponse { [JsonPropertyName("order")] public TelrCheckedOrder? Order { get; init; } [JsonPropertyName("error")] public TelrError? Error { get; init; } }
