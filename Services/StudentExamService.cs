    ...
    public class StudentExamService : IStudentExamService
    {
        ...
        public async Task<ApiResponse<StudentExamDto>> SubmitExamAsync(SubmitStudentExamDto dto)
        {
            try
            {
                ...
                studentExam.ExamStatusLookupId = new Guid("77777777-7777-7777-7777-777777777703");
        ...
        public async Task<ApiResponse<StudentExamSummaryDto>> GetStudentExamSummaryAsync(Guid studentId, Guid examId)
        {
            try
            {
                ...
                var lastExam = studentExams
                    .Where(e => e.CoursesMasterExamOid == examId && e.ExamStatusLookupId == new Guid("77777777-7777-7777-7777-777777777703") && e.ExamModeLookupId== new Guid("DDDDDDDD-DDDD-DDDD-1212-DDDDDDDDDD02"))
                    .FirstOrDefault();
                if (lastExam == null)
