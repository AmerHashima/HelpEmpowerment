...
namespace HelpEmpowermentApi.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpPost("search")]
        public async Task<ActionResult<PagedResponse<RoleDto>>> Search([FromBody] DataRequest request)
        {
        ...
        [HttpPut]
        public async Task<ActionResult<ApiResponse<RoleDto>>> Update([FromBody] UpdateRoleDto dto)
        {
